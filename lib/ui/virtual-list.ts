...
// the inspectors used to need disappears. The caller owns row content via
// renderRow; this owns the scroll handler and spacer geometry. The windowing math
// is the pure computeVirtualWindow.
//
